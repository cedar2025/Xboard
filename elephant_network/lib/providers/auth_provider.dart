...
class AuthProvider with ChangeNotifier {
  ...
  Future<String?> getQuickLoginUrl(String? redirect) async {
    try {
      ...
      debugPrint('DEBUG: AuthProvider.getQuickLoginUrl - Current Token: ${token?.substring(0, 10)}...');
  ...
  /// 找回密码
  Future<bool> forgetPassword(String email, String password, String emailCode) async {
    _isLoading = true;
    _errorMessage = null;
    notifyListeners();

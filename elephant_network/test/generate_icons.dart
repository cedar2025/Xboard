...
void main() {
  testWidgets('Generate Logo Base64', (WidgetTester tester) async {
    ...
    const svgString = '''<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" fill="none">
    ...
    final boundary = tester.renderObject(find.byKey(const Key('icon'))) as RenderRepaintBoundary;

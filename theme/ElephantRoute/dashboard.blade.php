...
<head>
  ...
  <link rel="stylesheet" href="/theme/{{$theme}}/assets/elephant-route-dashboard.css?v={{$version}}-er20260618clashMi2">
...
<body>
  ...
  <script src="/theme/{{$theme}}/assets/elephant-route-dashboard.js?v={{$version}}-er20260618clashMi2"></script>
  <script>
    (function() {

...
<head>
  ...
  <link rel="stylesheet" href="/theme/{{$theme}}/assets/elephant-route-dashboard.css?v={{$version}}-er20260527subscribeactions3">
  <script type="module" crossorigin src="/theme/{{$theme}}/assets/umi.js?v={{$version}}-er20260524fix1"></script>
...
<body>
  ...
  <script src="/theme/{{$theme}}/assets/elephant-route-dashboard.js?v={{$version}}-er20260527subscribeactions3"></script>
  <script>
    (function() {

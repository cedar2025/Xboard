    ...
    private function getConfigMappings(): array
    {
        return [
            ...
            'safe' => [
                ...
                'dify_support_enabled' => (bool) admin_setting('dify_support_enabled', env('DIFY_SUPPORT_ENABLED', true)),
                'dify_support_token' => admin_setting('dify_support_token', env('DIFY_SUPPORT_TOKEN', 'LnMUVn4RJRDzxGFm')),
                'dify_support_base_url' => admin_setting('dify_support_base_url', env('DIFY_SUPPORT_BASE_URL', 'https://ai.443ds443.com')),

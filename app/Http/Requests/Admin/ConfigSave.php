...
class ConfigSave extends FormRequest
{
    const RULES = [
        ...
        'customer_service_api_key' => 'nullable|min:32',
        'dify_support_enabled' => 'boolean',
        'dify_support_token' => 'nullable|string',
        'dify_support_base_url' => 'nullable|url',
    ...
    public function messages()
    {
        ...
        return [
            ...
            'customer_service_api_key.min' => '客服系统 API Key 长度不能小于32位',
            'dify_support_base_url.url' => 'Dify 服务地址格式不正确，必须携带http(s)://',

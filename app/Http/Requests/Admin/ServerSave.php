...
class ServerSave extends FormRequest
{
    ...
    private const PROTOCOL_RULES = [
        ...
        'tsunami' => [
            ...
            'transport.mode' => 'nullable|string|in:h2,websocket,raw',
            'transport.path' => 'nullable|string|max:255',
            'transport.host' => 'nullable|string|max:255',
            'tls' => 'nullable|array',
            'tls.server_name' => 'nullable|string|max:253',
            'tls.allow_insecure' => 'nullable|boolean',
            'tls.cert_file' => 'nullable|string|max:1024',
            'tls.key_file' => 'nullable|string|max:1024',
            'fronting' => 'nullable|array',
            'fronting.enabled' => 'nullable|boolean',
            'fronting.secret' => 'nullable|string|max:1024',
            'fronting.server_header' => 'nullable|string|max:255',
            'fronting.site_name' => 'nullable|string|max:255',
            'fronting.decoy_proxy' => 'nullable|string|max:1024',
            'surge' => 'nullable|array',
            'surge.mode' => 'nullable|string|in:auto,none',
            'surge.max_connections' => 'nullable|integer|min:1|max:1024',
            'surge.threshold' => 'nullable|integer|min:1|max:65535',
            'security' => 'nullable|array',
            'security.device_limit_mode' => 'nullable|string|in:ip,session',
            'routing' => 'nullable|array',
            'routing.allow_all' => 'nullable|boolean',
            'fallback' => 'nullable|string|max:255',
            'padding_scheme' => 'nullable|string|max:65535',
        ],
    ];
